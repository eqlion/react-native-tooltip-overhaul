...
import type {TipProps, TipProviderProps} from './types'
import {
  getItemCoordinates,
  getTipPositionProps,
  ARROW_WIDTH,
...
export default class TipProvider extends Component<TipProviderProps> {
  constructor(props) {
    super(props)
    this.state = {}
